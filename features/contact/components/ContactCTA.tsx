...
export default function ContactCTA() {
	...
	return (
		<section id="contact" ref={rootRef as React.RefObject<HTMLElement>} className="section relative container py-24 md:py-32 text-center overflow-hidden bg-black">
